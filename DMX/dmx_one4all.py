	...
	while True:
		try:
			...
			for ID in range(1, QuantidadeLampadas * CanaisPorLampada, CanaisPorLampada):
					...
					if Lampadas[nome] < 0:
						Lampadas[nome] = 0
					packet.payload[contador] = MapaCores[relacaoCores[Lampadas["LampadaAddress 1"]]]["R"]
					packet.payload[contador + 1] = MapaCores[relacaoCores[Lampadas["LampadaAddress 1"]]]["G"]
					packet.payload[contador + 2] = MapaCores[relacaoCores[Lampadas["LampadaAddress 1"]]]["B"]
